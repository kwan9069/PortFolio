function categoryChange(e) {
    ...
    var benz = ['E-클래스', 'EQC','C-클래스', 'CLS-클래스', 'CLA-클래스', 'CL-클래스', 'CLK-클래스','S-클래스', 'SLK-클래스','SLC-클래스', 'SLS AMG',  'SL-클래스','GLE-클래스','GLK-클래스',  'GLC-클래스', 'GLA-클래스', 'GLS-클래스',  'GL-클래스', 'G-클래스', 'GLB-클래스','A-클래스','AMG GT','A-클래스','M-클래스','스프린터','V-클래스','B-클래스','R-클래스'];
    var BMW = ['1시리즈', '2시리즈', '3시리즈', '4시리즈', '5시리즈', '6시리즈', '7시리즈', '8시리즈', 'X1', 'X3', 'X4', 'X5', 'X6', 'X7','M2', 'M3', 'M4', 'M5','M6','X4M', 'X5M', 'X6M','M4', 'M8','i3', 'i8','1M','Z4','그란투리스모'];
